...
enum msm_vfe_hvx_streaming_cmd { HVX_DISABLE, HVX_ONE_WAY, HVX_ROUND_TRIP };
...
#define V4L2_PIX_FMT_SBGGR14              \
    v4l2_fourcc('B', 'G', '1', '4') /* 14 \
                                       BGBG.GRGR.*/
#define V4L2_PIX_FMT_SGBRG14              \
    v4l2_fourcc('G', 'B', '1', '4') /* 14 \
                                       GBGB.RGRG.*/
#define V4L2_PIX_FMT_SGRBG14              \
    v4l2_fourcc('B', 'A', '1', '4') /* 14 \
                                       GRGR.BGBG.*/
#define V4L2_PIX_FMT_SRGGB14              \
    v4l2_fourcc('R', 'G', '1', '4') /* 14 \
                                       RGRG.GBGB.*/
...
#define VIDIOC_MSM_VFE_REG_CFG \
    _IOWR('V', MSM_VFE_REG_CFG, struct msm_vfe_cfg_cmd2)

#define VIDIOC_MSM_ISP_REQUEST_BUF \
    _IOWR('V', MSM_ISP_REQUEST_BUF, struct msm_isp_buf_request)

#define VIDIOC_MSM_ISP_ENQUEUE_BUF \
    _IOWR('V', MSM_ISP_ENQUEUE_BUF, struct msm_isp_qbuf_info)

#define VIDIOC_MSM_ISP_RELEASE_BUF \
    _IOWR('V', MSM_ISP_RELEASE_BUF, struct msm_isp_buf_request)

#define VIDIOC_MSM_ISP_REQUEST_STREAM \
    _IOWR('V', MSM_ISP_REQUEST_STREAM, struct msm_vfe_axi_stream_request_cmd)

#define VIDIOC_MSM_ISP_CFG_STREAM \
    _IOWR('V', MSM_ISP_CFG_STREAM, struct msm_vfe_axi_stream_cfg_cmd)

#define VIDIOC_MSM_ISP_RELEASE_STREAM \
    _IOWR('V', MSM_ISP_RELEASE_STREAM, struct msm_vfe_axi_stream_release_cmd)

#define VIDIOC_MSM_ISP_INPUT_CFG \
    _IOWR('V', MSM_ISP_INPUT_CFG, struct msm_vfe_input_cfg)

#define VIDIOC_MSM_ISP_SET_SRC_STATE \
    _IOWR('V', MSM_ISP_SET_SRC_STATE, struct msm_vfe_axi_src_state)
...
#define VIDIOC_MSM_ISP_CFG_STATS_STREAM \
    _IOWR('V', MSM_ISP_CFG_STATS_STREAM, struct msm_vfe_stats_stream_cfg_cmd)
...
#define VIDIOC_MSM_ISP_REG_UPDATE_CMD \
    _IOWR('V', MSM_ISP_REG_UPDATE_CMD, enum msm_vfe_input_src)

#define VIDIOC_MSM_ISP_UPDATE_STREAM \
    _IOWR('V', MSM_ISP_UPDATE_STREAM, struct msm_vfe_axi_stream_update_cmd)

#define VIDIOC_MSM_VFE_REG_LIST_CFG \
    _IOWR('V', MSM_VFE_REG_LIST_CFG, struct msm_vfe_cfg_cmd_list)
...
#define VIDIOC_MSM_ISP_AXI_HALT \
    _IOWR('V', MSM_ISP_AXI_HALT, struct msm_vfe_axi_halt_cmd)

#define VIDIOC_MSM_ISP_AXI_RESET \
    _IOWR('V', MSM_ISP_AXI_RESET, struct msm_vfe_axi_reset_cmd)

#define VIDIOC_MSM_ISP_AXI_RESTART \
    _IOWR('V', MSM_ISP_AXI_RESTART, struct msm_vfe_axi_restart_cmd)

#define VIDIOC_MSM_ISP_FETCH_ENG_START \
    _IOWR('V', MSM_ISP_FETCH_ENG_START, struct msm_vfe_fetch_eng_start)

#define VIDIOC_MSM_ISP_DEQUEUE_BUF \
    _IOWR('V', MSM_ISP_DEQUEUE_BUF, struct msm_isp_qbuf_info)
...
#define VIDIOC_MSM_ISP_MAP_BUF_START_FE \
    _IOWR('V', MSM_ISP_MAP_BUF_START_FE, struct msm_vfe_fetch_eng_start)

#define VIDIOC_MSM_ISP_UNMAP_BUF \
    _IOWR('V', MSM_ISP_UNMAP_BUF, struct msm_isp_unmap_buf_req)
...
#define VIDIOC_MSM_ISP_DUAL_HW_LPM_MODE \
    _IOWR('V', MSM_ISP_DUAL_HW_LPM_MODE, struct msm_vfe_dual_lpm_mode)
